...
<html>
<head>
<title>Not Found! - Boss Ragnarok Online</title>
...
<?php include('../includes/sidebar_left.php'); ?>	
			<div id="center">
				<div id="center_base">
					...
					<div id="center_main_title">Error 405</div>
					<div id="center_main_title_bottom"></div>
					<div id="center_container">
						<div id="container_title"><span>Method not allowed</span></div>
						<div id="container_content">
						<p>The method/action you are doing is not allowed in this website.</p>
						</div>
					</div>
				</div>
			</div>
