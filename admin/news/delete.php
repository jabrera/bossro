			...
			<div id="center">
				<div id="center_base">
					...
					<div id="center_container">
						<a name="delete"></a>
						<div id="container_title"><span>Delete a News</span></div>
						<div id="container_content">
						<p>
						<?php 
						if (isset($_GET['newsid'])) {
							$newsid = $_GET['newsid'];
							echo 'Are you sure you want to delete this news? You won\'t be able to retrieve it back after this action.<br><br><a href="index.php">No</a><br><br><a href="../process.php?table=news&action=delete&newsid='.$newsid.'">Yes</a>';
						}
						?>
						</p>
						</div>
